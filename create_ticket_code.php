...
// INSERT query
$insertQuery = "INSERT INTO tickets (ticket_id, created_by_id, created_by_role, created_by, issue_type, issue, mobile, ticket_email, image, office_pin, office_id, office_name, created_date) 
                VALUES (:ticketId, :userId, :createdByRole, :bcName, :issueType, :issue, :userMobile, :email, :img_path, :pin, :office_id, :office_name, :createdOn)";
